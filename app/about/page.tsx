...
export default function AboutPage() {
  return <main><SiteHeader /><div id="main-content">
    ...
    <section className="subpage-intro"><div className="section-kicker"><span>01</span><p>Our model</p></div><div className="subpage-intro-grid"><h2>Innovation, education, and community impact <em>working together.</em></h2><div><p className="lead">HBI is built on three integrated pillars: HBI STEAM Academy—the nonprofit arm of HBIVentures—HBI Innovation Foundry, and HBI Foundation.</p><p>Together, they create a continuous pipeline from education to innovation to workforce and community impact—delivering globally informed, locally relevant, and measurable outcomes.</p></div></div></section>
