...
export const metadata: Metadata = { title: "HBI STEAM Academy | HBIVentures", description: "The nonprofit arm of HBIVentures, delivering hands-on, project-based learning aligned to authentic industry, workforce, and community challenges." };
...
export default function AcademyPage(){return <main><SiteHeader/><div id="main-content">
  <section className="subpage-hero academy-hero"><div><p className="eyebrow"><span>●</span> Pillar 01 · Learn by building</p><h1>HBI STEAM<br /><em>Academy</em></h1></div><p>HBI STEAM Academy is the nonprofit arm of HBIVentures, developing future-ready talent through hands-on, project-based learning aligned to authentic industry, workforce, and community challenges.</p><div className="hero-index">01</div></section>
